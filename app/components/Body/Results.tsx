...
const Results: React.FC<TicketInfo> = ({
  ...
  return (
    <div className="bg-gradient-to-r from-20% from-blue-950 to-purple-900 flex flex-row border border-slate-900 rounded-2xl text-white shadow-2xl h-20 mb-20 pt-5 pb-40 md:pb-24">
