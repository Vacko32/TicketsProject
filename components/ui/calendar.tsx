  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        table:
          "w-full border-collapse space-y-1 from-sushidarkblue to-slate-700",
        head_row: "flex",
        head_cell:
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-slate-300"
        ),
        day_range_end: "day-range-end",
        day_selected: "bg-sushidarkblue ",
